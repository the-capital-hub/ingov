	...
	return (
		<footer className="bg-hero text-white relative overflow-hidden">
			<div className="section-inner py-10 lg:py-16 relative z-10 flex flex-col items-center text-center">
				<Link
					href="/"
					className="mb-4 transition-transform hover:scale-[1.02] inline-flex items-center justify-center"
				>
					<Image
						src="/ingov.png"
				...
				<p className="max-w-md text-sm text-white/80 mb-8 leading-relaxed">
					ERP Solution for Government. Made in India, Made for India. We process
					millions of secure transactions daily for departments nationwide.
				</p>
				<div className="flex gap-4 mb-10">
					<Link
						href="#"
						className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center hover:bg-white hover:text-hero text-white transition-all shadow-sm"
					>
				...
				<div className="w-full border-t border-white/20 pt-8 grid grid-cols-1 md:grid-cols-3 items-center gap-6 text-xs font-semibold text-white/70">
					<div className="text-center md:text-left order-2 md:order-1">
						&copy; {new Date().getFullYear()} InGov by iProfit. All Rights
						Reserved.
					</div>
