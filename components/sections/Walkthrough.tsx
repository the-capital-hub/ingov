...
import { ArrowRight, Play, Landmark, Users, LayoutDashboard } from 'lucide-react'
...
export default function Walkthrough() {
  ...
  return (
    <section id="walkthrough" className="bg-bgbase py-10 lg:py-16 relative overflow-hidden">
          ...
          <div className="w-full lg:w-[45%] flex flex-col items-start text-left">
            ...
            <FadeUp delay={0.1}>
              <h2 className="text-4xl md:text-5xl lg:text-5xl font-heading font-black text-dark mb-6 leading-tight mt-4">
                See InGov <em className="text-highlight italic font-medium">in 3 Minutes</em>
              </h2>
            </FadeUp>
            <FadeUp delay={0.2}>
              <p className="text-muted text-lg mb-10 leading-relaxed font-medium">
                Watch how Finance Officers, HR Managers, and Department Heads use InGov daily - no jargon, just real workflows.
              </p>
            </FadeUp>
                ...
                return (
                  <FadeUp delay={0.3 + (idx * 0.1)} key={idx}>
                    ...
                    >
                      ...
                      <div>
                        <h4 className={`font-heading font-bold text-lg mb-1.5 transition-colors duration-300 ${isActive ? 'text-dark' : 'text-dark/70'}`}>
                          {feature.title}
                        </h4>
                        <p className={`text-sm leading-relaxed transition-colors duration-300 ${isActive ? 'text-muted' : 'text-muted/70'}`}>
                          {feature.desc}
                        </p>
                      </div>
                    </div>
          ...
          <div className="w-full lg:w-[55%]">
            <FadeUp delay={0.4} className="w-full relative group">
              ...
              <div className="bg-card-grad rounded-[2.5rem] p-4 sm:p-6 border border-[#cde6fa]/50 shadow-sm relative overflow-hidden transition-all duration-500 lg:hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(2,132,199,0.15)] group">
                ...
                <div className="relative w-full aspect-video bg-white rounded-2xl border border-border overflow-hidden shadow-inner flex items-center justify-center bg-[url('/images/card-bg-light.png')] bg-cover bg-center">
              ...
              <div className="mt-6 text-center text-muted/80 text-sm font-medium flex items-center justify-center gap-2">
                Click <Play className="w-3 h-3 fill-muted/80" /> to play the {activeFeature === 0 ? "Finance" : activeFeature === 1 ? "Payroll" : "Executive"} Walkthrough
              </div>
            </FadeUp>
          </div>
