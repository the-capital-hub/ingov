...
export default function HowItWorks() {
	...
	return (
		<section
			id="how-it-works"
			className="bg-bgbase py-10 lg:py-16 overflow-hidden relative"
		>
			...
			<div className="section-inner relative z-10 max-w-5xl mx-auto">
				...
				<div className="text-center mb-24">
					...
					<FadeUp delay={0.2}>
						<p className="max-w-2xl mx-auto text-muted text-lg leading-relaxed">
							Our structured 4-phase implementation has delivered a 98%+ go-live
							success rate across government departments of every size.
						</p>
					</FadeUp>
				</div>
				...
				<div
					ref={containerRef}
					className="relative max-w-3xl mx-auto px-4 sm:px-0"
				>
					...
					<div className="space-y-10">
						{steps.map((step, i) => {
							...
							return (
								<div
									key={i}
									className="relative flex items-center w-full justify-between group"
								>
										...
										{isEven ? (
											...
											<FadeUp delay={0.2} className="w-full">
												<div className="bg-card-grad border border-[#cde6fa]/50 rounded-3xl p-8 shadow-sm text-right lg:hover:border-highlight/30 transition-colors">
													<h4 className="font-heading font-black text-dark text-2xl mb-3">
														{step.title}
													</h4>
											...
											<FadeUp delay={0.2} className="w-full text-center">
												<div className="font-body font-black text-4xl lg:text-5xl text-highlight/50 tracking-tight leading-tight">
													{step.duration.split(" ")[0]}
													<br />
										...
										{isEven ? (
											<>
												...
												<div className="sm:hidden w-full">
													<FadeUp
														delay={0.2}
														className="w-full bg-card-grad border border-[#cde6fa]/50 rounded-3xl p-6 shadow-sm text-left"
													>
														<div className="inline-block text-xs font-bold px-3 py-1 bg-white border border-border text-highlight rounded-full mb-4">
															{step.duration}
														</div>
														<h4 className="font-heading font-black text-dark text-xl mb-3">
															{step.title}
														</h4>
											...
											<FadeUp
												delay={0.2}
												className="w-full bg-card-grad border border-[#cde6fa]/50 rounded-3xl p-6 sm:p-8 shadow-sm text-left lg:hover:border-highlight/30 transition-colors"
											>
												...
												<h4 className="font-heading font-black text-dark text-xl sm:text-2xl mb-3">
													{step.title}
												</h4>
