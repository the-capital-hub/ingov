...
const modules = [
  {
    ...
    features: ['Project & branch based accounting', 'GST filing & e-invoicing compliance', 'Consolidated financial reports', 'HDFC & IndusInd bank integration', 'Budget management & tracking'],
  ...
  },
  {
    ...
    features: ['Processes 11,000+ salaries monthly', 'Leave & attendance tracking', 'Payroll with statutory compliance', 'Employee self-service portal', 'Organisation & personnel management'],
  ...
  },
  {
    ...
    features: ['Procurement management', 'Warehouse data management', 'Material forecasting', 'Vendor record management', 'Sales order processing'],
  ...
  },
  {
    ...
    features: ['Digital asset lifecycle tracking', 'Asset procurement & card management', 'Transaction & depreciation tracking', 'Maintenance scheduling', 'Master data setup'],
  ...
  },
  {
    ...
    features: ['Task management', 'Resource allocation', 'Payment tracking', 'Progress monitoring', 'Multi-project dashboards'],
  ...
  },
  {
    ...
    features: ['Real-time leadership dashboards', 'Predictive analytics', 'Custom data visualisation', 'Performance tracking tracking', 'Document management system'],
...
export default function Modules() {
  return (
    <section id="modules" className="bg-bgbase py-10 lg:py-16 relative overflow-hidden">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <FadeUp delay={0.1}>
            <h2 className="text-4xl md:text-5xl lg:text-5xl font-heading font-black text-dark mb-6 leading-tight mt-5">
              Six Integrated Modules,<br className="hidden md:block" />
              One Unified <em className="text-highlight italic">Platform</em>
            </h2>
          </FadeUp>
          <FadeUp delay={0.2}>
            <p className="mx-auto text-muted text-lg leading-relaxed">
              Every module is built precisely for the strict workflows, compliance requirements, and reporting needs of massive Indian government departments.
            </p>
          </FadeUp>
        </div>
                  ...
                  <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
                    ...
                    <ul className="space-y-5 mb-12">
                      {m.features.map((f, idx) => (
                        <li key={idx} className="flex items-center gap-4 text-base text-dark">
        ...
        <FadeUp delay={0.3}>
          <div className="relative overflow-hidden bg-card-grad border border-[#cde6fa]/50 rounded-[2.5rem] p-10 md:p-16 shadow-sm max-w-5xl mx-auto flex flex-col items-center text-center">
            ...
            <p className="text-muted text-lg max-w-2xl mx-auto leading-relaxed">
              The InGov architecture is designed to grow with you. Our core modules plug directly into powerful upcoming extensions to continually modernize your operations.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-3xl mt-10">
              ...
              <div className="bg-white border border-border rounded-3xl p-8 flex flex-col items-center hover:border-highlight/30 hover:shadow-md transition-all duration-300 text-center group cursor-default">
                ...
                <h4 className="font-heading font-black text-dark text-xl mb-3 group-hover:text-highlight transition-colors duration-300">Tender Management</h4>
                <p className="text-muted text-sm leading-relaxed max-w-[250px]">End-to-end digital lifecycle handling for public procurements.</p>
              </div>
              ...
              <div className="bg-white border border-border rounded-3xl p-8 flex flex-col items-center hover:border-highlight/30 hover:shadow-md transition-all duration-300 text-center group cursor-default">
                ...
                <h4 className="font-heading font-black text-dark text-xl mb-3 group-hover:text-highlight transition-colors duration-300">Govt Fund Management</h4>
                <p className="text-muted text-sm leading-relaxed max-w-[250px]">Secure, auditable allocation and tracking of state grants.</p>
              </div>
            </div>
